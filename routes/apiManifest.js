...
module.exports = {
  ...
  version: '2.0.1',
  message:
    'Welcome to the San Jose Parks App! Here is some information about its api:',
  documentationUrl:
    'https://github.com/irishka2863/SJParks/blob/master/README.md',
  ...
  routes: [
    ...
    },
    {
      ...
      method: 'POST',
      desc:
        'This will authenticate a user provided userName/phone/email and password.',
      params: {
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'This will logout current user (i.e. destroy session) and redirect to login page',
      params: {},
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'Redirects @adminId to main admin page. Admin credentials required.',
      params: {},
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'Fetches the index of all messages; both messages recieved and messages sent',
      params: {},
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'Retrives the list of every user currently subscribed to @parkId, each in JSON format',
      params: {},
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'Retrives the list of every park to which @userId is currently subscribed, each in JSON format',
      params: {},
    ...
    },
    {
      ...
      method: 'GET',
      desc:
        'Retrives the list of every message that @userId has ever sent or recieved',
      params: {},
      function: 'api.parks.getAllSubscribers',
      response: {
        type: 'JSON',
    ...
    },
    {
      ...
      method: 'POST',
      desc:
        " Uploads a @userId's profile image to Cloudinary and stores url reference in User object",
      params: {
